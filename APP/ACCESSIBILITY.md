...
| Tamaño mínimo de texto de cuerpo | 14sp (ver [[DESIGN_SYSTEM]] §1.2) |
...
- Mensajes de error específicos y accionables (ver mapeo de `VALIDATION_ERROR` en [[API_INTEGRATION]] §3) — nunca solo "Error" sin indicar qué campo o qué corregir.
...
| Documento | Propósito |
|---|---|
| [[DESIGN_SYSTEM]] | Tokens de color/tipografía/espaciado sobre los que se aplican estas reglas |
| [[TESTING]] | Tests automatizados de accesibilidad (`flutter_test` + `meets_accessibility_guidelines`) |
