...
│       │   └── api-review.md         ← Primario read-only (deepseek-v4-pro)
│       └── skills\
...
│       │   └── web-build.md          ← Primario/subagente (kimi-k2.7-code)
│       └── skills\
│           └── close-session\SKILL.md
│
├── APP\                        ← Código Flutter
...
| Escribir código | `kimi-k2.7-code` | $0.95 / $4.00 | Especializado en coding |
| Revisar sin modificar | `deepseek-v4-pro` | $1.74 / $3.48 | Análisis y juicio |
