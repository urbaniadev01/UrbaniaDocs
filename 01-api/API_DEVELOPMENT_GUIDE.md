...
1. **Scope lock**: No salir del scope definido en [[API_IMPLEMENTATION_PLAN]] para esta sesion
2. **Test-driven**: Escribir test antes o junto al codigo ([[API_TESTING]] Sec 6.3 FIRST)
...
**Prevencion**: El docker-compose.yml de [[API_ARCHITECTURE]] incluye healthcheck. Asegurar que `depends_on` con `condition: service_healthy` este configurado.
...
- Checklist de [[API_AGENTS]] aplicado
...
|-----------|------------------|
| [[API_IMPLEMENTATION_PLAN]] | Plan de sesiones, scope de trabajo |
| [[API_SESSION_MANIFEST]] | Estado actual del proyecto |
| [[API_AGENTS]] | Flujos de trabajo, reglas de oro, checklists |
| [[API_ARCHITECTURE]] | Stack, DDD, convenciones, reglas de dependencia |
| [[API_SETUP_GUIDE]] | Inicializacion, Docker, dependencias |
| [[API_TESTING]] | Estructura de tests, reglas, cobertura |
| [[API_CONTRACT]] | Endpoints, request/response, errores |
| [[API_JWT_IMPLEMENTATION]] | Seguridad JWT, MFA, headers |
| [[API_DATABASE]] | Esquema, migraciones, convenciones BD |
