...
| 5 | GET | `/comunicaciones/surveys` | `comunicaciones.ver` | Implementado |
| 6 | POST | `/comunicaciones/surveys` | `comunicaciones.crear` | Diseñado |
| 7 | GET | `/comunicaciones/surveys/:id/results` | `comunicaciones.ver` | Diseñado |
| 8 | POST | `/comunicaciones/surveys/:id/responses` | (residente) | Diseñado |
| 9 | GET/PUT | `/comunicaciones/channels` | `comunicaciones.configurar` | Diseñado |
...
## §5 Listar encuestas
```
GET /api/v1/comunicaciones/surveys?activa&page
```
**Response 200:** lista paginada con `{ id, pregunta, tipo, cierra_el, activa, opciones_count, responses_count, created_at }`.
...
## §8 Responder encuesta (residente)
```
