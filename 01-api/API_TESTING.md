...
> **Prohibido**: Usar SQLite para testing. PostgreSQL real obligatorio ([[API_ARCHITECTURE]] Sección 1).
...
> [[API_SETUP_GUIDE]] Sección 9.3 (Configuración de Pest)
> 
...
> **Documentación completa**: [[API_ARCHITECTURE]] Sección 3 (Reglas de Dependencia)
...
> [[API_ARCHITECTURE]] Sección 4
> **Value Objects**: [[API_ARCHITECTURE]] Sección 2 (Domain/ValueObjects)
> **Entities**: [[API_ARCHITECTURE]] Sección 2 (Domain/Entities)
...
> [[API_ARCHITECTURE]] Sección 6
> **JWT Claims**: [[API_JWT_IMPLEMENTATION]] Sección 3.2
> **JWT TTL**: [[API_JWT_IMPLEMENTATION]] Sección 3.3 (15 minutos)
> **Algoritmo RS256**: [[API_JWT_IMPLEMENTATION]] Sección 3.1
...
> **Rate Limiting**: [[API_CONTRACT]] Sección "Rate Limiting" y [[API_JWT_IMPLEMENTATION]] Sección 3.1
> **Headers de seguridad**: [[API_JWT_IMPLEMENTATION]] Sección 4.1
...
**Propósito**: Probar mecanismos de seguridad específicos documentados en [[API_JWT_IMPLEMENTATION]].

**Áreas críticas a testear**:

#### Token Rotation ([[API_JWT_IMPLEMENTATION]] Sección 3.2)
```php
...
#### Device Fingerprint ([[API_JWT_IMPLEMENTATION]] Sección 3.3)
```php
...
#### MFA ([[API_JWT_IMPLEMENTATION]] Sección 6)
```php
...
> [[API_JWT_IMPLEMENTATION]] Sección 3.2
> **Device fingerprint**: [[API_JWT_IMPLEMENTATION]] Sección 3.3
> **MFA/TOTP**: [[API_JWT_IMPLEMENTATION]] Sección 6
> **Rate limiting**: [[API_JWT_IMPLEMENTATION]] Sección 3.1 y [[API_CONTRACT]] Sección "Rate Limiting"
> **Brute force**: [[API_JWT_IMPLEMENTATION]] Sección 3.1 y [[API_DATABASE]] (users.failed_login_attempts)
> **Eventos de seguridad**: [[API_JWT_IMPLEMENTATION]] Sección 6.1
...
> [[API_DATABASE]] Sección 2.1
> **Esquema de refresh_tokens**: [[API_DATABASE]] Sección 2.2
> **Esquema de password_history**: [[API_DATABASE]] Sección 2.3
> **Esquema de login_attempts**: [[API_DATABASE]] Sección 2.4
> **Esquema de security_events**: [[API_DATABASE]] Sección 2.5
> **Esquema de password_reset_tokens**: [[API_DATABASE]] Sección 2.6
...
Ver [[API_SETUP_GUIDE]] §12.2 para la lista completa de scripts de calidad:
- `composer test:coverage` - Ejecuta tests con cobertura
- `composer ci` - Pipeline completo

Para desarrollo local, usar los scripts definidos en `composer.json` según [[API_SETUP_GUIDE]].
...
- [ ] [[API_SESSION_MANIFEST]] actualizado con metricas de calidad de esta sesion
- [ ] [[API_IMPLEMENTATION_PLAN]] verificado (sin cambios si no se modifica el plan)
- [ ] [[API_DEVELOPMENT_GUIDE]] actualizado si se encontraron problemas de testing
...
> [!note] Nota
> Cada sesion del [[API_IMPLEMENTATION_PLAN]] tiene un scope de testing especifico.
...
|--------|-------------------------|-------------------|----------------------|
| 1 | Feature (Health Check) | 100% del endpoint | [[API_TESTING]] Sec 3.4 |
| 2 | Architecture + Unit | Domain >=95% | [[API_TESTING]] Sec 3.1, 3.2 |
| 3 | Unit (UseCases) + Integration (JWT) | Application >=90% | [[API_TESTING]] Sec 3.2, 3.3 |
| 4 | Integration (Repositories, Mappers) | Infrastructure >=85% | [[API_TESTING]] Sec 3.3 |
| 5 | Feature (Endpoints HTTP) | Presentation >=80% | [[API_TESTING]] Sec 3.4 |
| 6 | Security (JWT, MFA, Device, Rotacion) | Security 100% | [[API_TESTING]] Sec 3.5 |
| 7 | Feature + Security (Password, Perfil) | Security 100% | [[API_TESTING]] Sec 3.4, 3.5 |
| 8 | Todos los anteriores + Coverage global | Global >=80% | [[API_TESTING]] Sec 5 |