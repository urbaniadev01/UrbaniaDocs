...
module: auth
scope: cross-project
tags: [api, endpoints, rest, cross-project]
updated: 2026-06-18
---
...
> **Estado**: "Diseñado" = contrato definido aqui, pendiente o en implementacion. "Implementado" = codigo y tests en `main`. Actualizar la columna al cerrar cada endpoint (ver checklist de [[API_AGENTS]]).
...
> [!note] Nota
> El login requiere `email` y `password`. Si el usuario tiene MFA habilitado, el login retorna 401 con `error.code = "MFA_REQUIRED"`. Ver [[API_JWT_IMPLEMENTATION]] §7.1.
...
> [!note] Implementacion
> Ver [[API_SETUP_GUIDE]] §10 para verificacion post-setup.
...
- [ ] Verificar rate limiting en "Rate Limiting" / [[API_JWT_IMPLEMENTATION]] §4.1
...
- [ ] Verificar que el endpoint esta en el scope de la sesion actual ([[API_IMPLEMENTATION_PLAN]])
- [ ] Si requiere cambios en sesiones anteriores (Domain, Application), documentar como deuda tecnica en [[API_SESSION_MANIFEST]]
