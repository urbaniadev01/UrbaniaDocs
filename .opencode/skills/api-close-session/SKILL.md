...
Archivo: `documentacion/01-api/API_SESSION_MANIFEST.md`
...
Archivo: `documentacion/01-api/API_IMPLEMENTATION_PLAN.md`
...
- Verificar que `documentacion/01-api/API_CONTRACT.md` lo marca como "Implementado"

Si se creó o modificó una tabla:
- Verificar que `documentacion/01-api/API_DATABASE.md` refleja el estado actual
...
Crear archivo en `documentacion/01-api/docs/log/sesiones/sesion-N.md` usando la plantilla `documentacion/01-api/_templates/nueva-sesion.md`.
