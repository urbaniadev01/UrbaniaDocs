...
> [!info]
> Para consultar el Modelo de base de datos -> [[DATABASE]]
---
...
```
Ver [[DATABASE]] §2.1 para la definición exacta de la columna mfa_backup_codes.
...
- [ ] Actualizar [[SESSION_MANIFEST]] con eventos de seguridad detectados en monitoreo
