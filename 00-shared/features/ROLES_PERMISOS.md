...
tags: [feature, rbac, roles, permisos, implemented]
updated: 2026-06-29
---

# Feature: Roles y Permisos (RBAC)

> **IMPLEMENTADO** — API: 8 endpoints HTTP (Sesión 18) + Web: panel completo (Sesión 6). La base RBAC (migraciones, modelos, resolver, middleware) vino de CAMBIO-006. Diseño de pantallas en [[_RESEARCH_pantallas-mvp]] §5; modelo en [[_RESEARCH_modelo-datos]] §4.
...
| Proyecto | Estado | Sesión | Archivos |
|---|---|---|---|
| API | ✅ Implementado (8 endpoints) | Sesión 18 (2026-06-29) | 5 controllers, 8 form requests, 7 resources, 11 use cases, 2 models, rutas + provider |
| Web | ✅ Implementado (panel completo) | Sesión 6 (2026-06-29) | 19 archivos (types, api, 6 hooks, 5 componentes, 5 páginas) + 2 tests |
| App | N/A (MVP) | — | — |
